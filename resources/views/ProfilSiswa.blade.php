        ...
        <div class="box" style="margin-top: -1em;">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="active">
                    <a data-toggle="tab" href="#profile" role="tab" aria-controls="home"><span><i class="fa fa-vcard"></i></span> Profil</a>
                    </li>
                    <li class="nav-item">
                    <a  data-toggle="tab" href="#akademik" role="tab" aria-controls="profile"><span><i class="fa fa-book"></i></span> Akademik</a>
                    </li>
                    <li class="nav-item">
                    <a  data-toggle="tab" href="#kepesantrenan" role="tab"><span><i class="fa fa-university"></i></span> Kepesantrenan</a>
                    </li>
                    <li class="nav-item">
                    <a  data-toggle="tab" href="#prestasi" role="tab"><span><i class="fa fa-trophy"></i></span> Prestasi</a>
                    </li>
                    <li class="nav-item">
                    <a  data-toggle="tab" href="#pelanggaran" role="tab"><span><i class="fa fa-bomb"></i></span> Pelanggaran</a>
                    </li>
                    <li class="nav-item">
                    <a  data-toggle="tab" href="#catatan" role="tab"><span><i class="fa fa-file-text-o"></i></span> Catatan</a>
                    </li>
                </ul>
            </div>
            <div class="box-body">
