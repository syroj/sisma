                    ...
                    {{csrf_field()}}
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Nama</td>
                                    <td><input type="text" name="nama" class="form-control" value="{{$siswa->nama}}"></td>
                                    <td>NIS</td>
                                    <td><input type="text" name="nis" class="form-control" value="{{$siswa->nis}}" readonly="true"></td>
                                    <td>NISN</td>
                                    <td><input type="text" name="nisn" class="form-control" value="{{$siswa->nisn}}"></td>
                                </tr>
                                <tr>
                                    <td>No KK</td>
                                    <td><input type="text" name="no_kk" class="form-control"value="{{$siswa->no_kk}}"></td>
                                    <td>NIK</td>
                                    <td colspan="3"><input type="text" name="nik" class="form-control"value="{{$siswa->nik}}"></td>
                                    
                                </tr>
                                <tr>
                                    <td>TTL</td>
                                    <td>
                                        <input type="text" name="tmp_lahir" class="form-control" placeholder="Tempat Lahir"value="{{$siswa->tmp_lahir}}">
                                    </td>
                                    <td>Tanggal Lahir</td>
                                    <td><input type="text" name="tgl_lahir" class="form-control" placeholder="Tanggal Lahir" value="{{$siswa->tgl_lahir}}"></td>
                                    <td>Jenis Kelamin</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="jml_saudara" class="form-control" value="{{$siswa->jml_saudara}}"></td>
                                    <td>Anak Ke</td>
                                    <td><input type="text" name="anak_ke" class="form-control" value="{{$siswa->anak_ke}}"></td>
                                    <td>Agama</td>
                                ...
                                <tr>
                                    <td>Dusun</td>
                                    <td><input type="text" name="dusun_siswa" class="form-control" value="{{$alamat->dusun}}"></td>
                                    <td>Desa</td>
                                    <td><input type="text" name="desa_siswa" class="form-control"value="{{$alamat->desa}}"></td>
                                    <td>Kecamatan</td>
                                    <td><input type="text" name="kecamatan_siswa" class="form-control" value="{{$alamat->kecamatan}}"></td>
                                </tr>
                                <tr>
                                    <td>Kabupaten</td>
                                    <td><input type="text" name="kabupaten_siswa" class="form-control" value="{{$alamat->kabupaten}}"></td>
                                    <td>Provinsi</td>
                                    <td><input type="text" name="provinsi_siswa" class="form-control" value="{{$alamat->provinsi}}"></td>
                                    <td>Kode Pos</td>
                                    <td><input type="text" name="kode_pos_siswa" class="form-control" value="{{$alamat->kode_pos}}"></td>
                                </tr>
                                @endforeach
                                @else
                                <tr>
                                ...
                                <tr>
                                    <td>Nama Ayah</td>
                                    <td><input type="text" name="nama_ayah" class="form-control" value="{{$ayah->nama}}"></td>
                                    <td>Pekerjaan</td>
                                    <td><input type="text" name="pekerjaan_ayah" class="form-control" value="{{$ayah->pekerjaan}}"></td>
                                    <td>Agama</td>
                                    <td><input type="text" name="agama_ayah" class="form-control" value="{{$ayah->agama}}"></td>
                                </tr>
                                <tr>
                                    <td>No. Telp</td>
                                    <td><input type="text" name="telp_ayah" class="form-control" value="{{$ayah->tlp}}"></td>
                                    <td>Email ayah</td>
                                    <td><input type="text" name="email_ayah" class="form-control" value="{{$ayah->email}}"></td>
                                    <td>Penghasilan ayah</td>
                                    <td><input type="text" name="penghasilan_ayah" class="form-control" value="{{$ayah->penghasilan}}"></td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td colspan="5"><textarea name="alamat_ayah" class="form-control">{{$ayah->alamat}}</textarea></td>
                                </tr>
                                @endforeach
                                @else
                                <tr><th colspan="6">Data Ayah</th></tr>
                                ...
                                <tr>
                                    <td>Nama ibu</td>
                                    <td><input type="text" name="nama_ibu" class="form-control" value="{{$ibu->nama}}"></td>
                                    <td>Pekerjaan</td>
                                    <td><input type="text" name="pekerjaan_ibu" class="form-control" value="{{$ibu->pekerjaan}}"></td>
                                    <td>Agama</td>
                                    <td><input type="text" name="agama_ibu" class="form-control" value="{{$ibu->agama}}"></td>
                                </tr>
                                <tr>
                                    <td>No. Telp</td>
                                    <td><input type="text" name="telp_ibu" class="form-control" value="{{$ibu->tlp}}"></td>
                                    <td>Email ibu</td>
                                    <td><input type="text" name="email_ibu" class="form-control" value="{{$ibu->email}}"></td>
                                    <td>Penghasilan ibu</td>
                                    <td><input type="text" name="penghasilan_ibu" class="form-control" value="{{$ibu->penghasilan}}"></td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td colspan="5"><textarea name="alamat_ibu" class="form-control">{{$ibu->alamat}} </textarea></td>
                                </tr>
                                @endforeach
                                @else
                                <tr><th colspan="6">Data ibu</th></tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4"><input type="text" name="asal_sekolah" class="form-control" value="{{$asal_sekolah->asal_sekolah}}"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Dusun</td>
                                    <td><input type="text" name="dusun_sekolah" class="form-control" value="{{$asal_sekolah->dusun}}"></td>
                                    <td>Desa</td>
                                    <td><input type="text" name="desa_sekolah" class="form-control" value="{{$asal_sekolah->desa}}"></td>
                                    <td>Kecamatan</td>
                                    <td><input type="text" name="kecamatan_sekolah" class="form-control" value="{{$asal_sekolah->kecamatan}}"></td>
                                </tr>
                                <tr>
                                    <td>Kabupaten</td>
                                    <td><input type="text" name="kabupaten_sekolah" class="form-control" value="{{$asal_sekolah->kabupaten}}"></td>
                                    <td>Provinsi</td>
                                    <td><input type="text" name="provinsi_sekolah" class="form-control" value="{{$asal_sekolah->provinsi}}"></td>
                                    <td>Kode Pos</td>
                                    <td><input type="text" name="kode_pos_sekolah" class="form-control" value="{{$asal_sekolah->kode_pos}}"></td>
                                </tr>
                                @endforeach
                                @else
                                <th colspan="6">Asal Sekolah</th>
